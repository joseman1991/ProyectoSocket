...
public class controladorArticulo {
    ...
    private controladorCategoria ctrl_categoria;
    private controladorSubCategorias ctrl_sub_categoria;
    ...
    public void IniciarVistaArticulo() {
        switch (op) {
            ...
            case 2:
                ...
                vista_articulo.titulo.setText("ACTUALIZAR ART√çCULO");
    ...
    private void eventos() {
            ...
            case 2:
                ...
                vista_articulo.buscaT.addActionListener((ActionEvent e) -> {
                    if (vista_articulo.buscaT.isSelected()) {
                        ...
                        vista_articulo.buscaT.setToolTipText("Busca por categorÌa");
                        vista_articulo.buscaT.setText("Buscar por categorÌas");
        ...
        vista_articulo.accion.addActionListener((ActionEvent e) -> {
            if (vista_articulo.descripcion.getText().equals("")) {
                JOptionPane.showMessageDialog(vista_articulo, "Ingresa el nombre del artÌculo", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (Double.parseDouble(vista_articulo.pvp.getValue().toString()) == 0) {
                JOptionPane.showMessageDialog(vista_articulo, "Ingresa el precio de venta al p˙blico del artÌculo", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (vista_articulo.subcategoria.getItemCount() == 0) {
                JOptionPane.showMessageDialog(vista_articulo, "Selecciona una subcategorÌa", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (vista_articulo.categorias.getItemCount() == 0) {
                JOptionPane.showMessageDialog(vista_articulo, "Selecciona una categorÌa", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                try {
                    ...
                    switch (op) {
                        ...
                        case 2:
                            if (vista_articulo.codArt.getText().equals("")) {
                                JOptionPane.showMessageDialog(vista_articulo, "Selecciona el artÌculo que deseas actualizar", "Error", JOptionPane.ERROR_MESSAGE);
                            } else {
                    ...
                    if (exc == 1) {
                        ...
                        JOptionPane.showMessageDialog(vista_articulo, "ArtÌculo " + operacion + " exitosamente", "Exito", JOptionPane.INFORMATION_MESSAGE);
                        vista_articulo.codArt.setText(articuloDAO.nextCodigoArt());
    ...
    private void inicializarCategorias() {
        ...
        ctrl_categoria = new controladorCategoria(vista_categorias);
    }
    ...
    private void inicializarSubCategorias() {
        ...
        ctrl_sub_categoria = new controladorSubCategorias(vista_subcategorias);
    }
